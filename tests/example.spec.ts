...
test.describe('New Todo', () => {
  ...
  test('test', async ({ page }) => {
    ...
    // Press Enter
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://www.amazon.com/s?k=nvidia&crid=SRDNCMI9ZLMA&sprefix=nvidia%2Caps%2C94&ref=nb_sb_noss_1' }*/),
      page.locator('[aria-label="Search"]').press('Enter')
    ]);
    // Click img[alt="Sponsored\ Ad\ -\ NVIDIA\ GT\ 730\ Graphics\ Card\,\ Computer\ Low\ Profile\ GPU\,\ 4GB\ 128Bit\ DDR3\ PCIe\ x16\,\ HDMI\/VGA\/DVI\,\ DirectX\ 11\,\ \.\.\."]
    await page.locator('img[alt="Sponsored\\ Ad\\ -\\ NVIDIA\\ GT\\ 730\\ Graphics\\ Card\\,\\ Computer\\ Low\\ Profile\\ GPU\\,\\ 4GB\\ 128Bit\\ DDR3\\ PCIe\\ x16\\,\\ HDMI\\/VGA\\/DVI\\,\\ DirectX\\ 11\\,\\ \\.\\.\\."]').click();
    await expect(page).toHaveURL('https://www.amazon.com/GT-730-Graphics-Computer-Profile/dp/B09KTFWNPK/ref=sr_1_1_sspa?crid=SRDNCMI9ZLMA&keywords=nvidia&qid=1645902418&sprefix=nvidia%2Caps%2C94&sr=8-1-spons&psc=1&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUE1S0FHNUVGUkk2M1gmZW5jcnlwdGVkSWQ9QTA5Nzc2NzUxOFFGMU8yVVJWVDM2JmVuY3J5cHRlZEFkSWQ9QTA2MDU1MTAyTDJORTlUWE9HRkdDJndpZGdldE5hbWU9c3BfYXRmJmFjdGlvbj1jbGlja1JlZGlyZWN0JmRvTm90TG9nQ2xpY2s9dHJ1ZQ==');
    // Go to https://www.amazon.com/s?k=nvidia&crid=SRDNCMI9ZLMA&sprefix=nvidia%2Caps%2C94&ref=nb_sb_noss_1
    await page.goto('https://www.amazon.com/s?k=nvidia&crid=SRDNCMI9ZLMA&sprefix=nvidia%2Caps%2C94&ref=nb_sb_noss_1');
  });
});
